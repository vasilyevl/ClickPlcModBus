using Grumpy.ClickPLC.Net.Driver;
using System.Text.RegularExpressions;

namespace Grumpy.ClickPLC.Net.Tester
{
    ...
    {
        static IClickModBusDriver _driver = null!;
        ...
        static int Main(string[] args) {
            ...
            if (!ClickModBusDriver.CreateDriver(configuration, out _driver!)) {
                Console.WriteLine("Failed to create driver.");
                return -1;
            }

            Console.WriteLine("PLC driver instance created.");

            if (!_driver.Open()) {

                exitCode = -1;
                Console.WriteLine("\n\nFailed to open connection with CLIK PLC.\n\n");
                return exitCode;
            }
        ...
        private static int DoDiscreteIOs(string io, SwitchCtrl[] controls,
            ...
            if (!_driver.ReadDiscreteControls(io, controls.Length, out SwitchState[] status)) {
            ...
            if (!_driver.WriteDiscreteControls(io, controls)) {
            ...
            if (!_driver.ReadDiscreteControls(io, controls.Length, out status)) {
                Console.WriteLine($"Failed to read status of " +
        ...
        private static int DoSingleIO(string io, int repeats = 4) {
            ...
            for (int i = 0; i < repeats; i++) {
                ...
                if (!_driver.WriteDiscreteControl(io, ctrl)) {
                ...
                if (!_driver.ReadDiscreteControl(io, out SwitchState status)) {
                    return -2;
                }
        ...
        private static int DoSimpleTimerTest(string timer, string setRegister, string controlRelay, int timerTimeMs) {
            ...
            if (_driver.WriteDiscreteControl(controlRelay, SwitchCtrl.Off)) {
            ...
            if (_driver.ReadUInt16Register(setRegister, out ushort timerValue)) {
            ...
            if (_driver.WriteUInt16Register(setRegister, (ushort)timerTimeMs)) {
            ...
            if (_driver.ReadUInt16Register(setRegister, out timerValue)) {
                Console.WriteLine($"Current timer set value: {timerValue}.");
            }
            else {
            ...
            if (_driver.ReadUInt16Register(timerCurrentValueRegister, out timerValue)) {
            ...
            if (_driver.ReadDiscreteControl(timer, out SwitchState switchState)) {
            ...
            if (_driver.WriteDiscreteControl(controlRelay, SwitchCtrl.On)) {
            ...
            while (true) {
                ...
                if (!_driver.ReadDiscreteControl(timer, out switchState)) {
                    ...
                    case SwitchSt.On:
                        ...
                        if (_driver.WriteDiscreteControl(controlRelay, SwitchCtrl.Off)) {
                            Console.WriteLine($"Control relay " +
                                ...
                                _driver.WriteUInt16Register(setRegister, 0);
                            if (_driver.WriteUInt16Register(setRegister, 0)) {
        ...
        private static int DoSimpleCounterTest(string counter, string setValueRegister,
            ...
            if (_driver.WriteUInt16Register(setValueRegister, (ushort)setPoint)) {
            ...
            if (_driver.ReadUInt16Register(setValueRegister, out ushort setPointValue)) {
            ...
            if (_driver.WriteDiscreteControl(resetRelay, SwitchCtrl.On)) {
            ...
            if (_driver.WriteDiscreteControl(resetRelay, SwitchCtrl.Off)) {
            ...
            if (_driver.ReadUInt16Register(counterCurrentValueRegister, out ushort counterValue)) {
            ...
            if (_driver.ReadDiscreteControl(counter, out SwitchState switchState)) {
            ...
            while (switchState.State != SwitchSt.On) {
                ...
                if (_driver.ReadDiscreteControl(counter, out switchState)) {
        ...
        public static int ReadIOs(string startIO, int ioLen, string name) {
            ...
            if (!_driver.ReadDiscreteControls(startIO, ioLen, out SwitchState[] status)) {
        ...
        internal static int AIOTest() {
            ...
            for (int i = 0; i < steps; i++) {
                ...
                if (!_driver.WriteFloat32Register(FloatRegisterDA1, da1WriteValue)) {
                ...
                if (!_driver.WriteFloat32Register(FloatRegisterDA2, da2WriteValue)) {
                ...
                if (!_driver.ReadFloat32Register(floatRegisterAD1, out float readValue1)) {
                ...
                if (!_driver.ReadFloat32Register(floatRegisterAD2, out float readValue2)) {
                    Console.WriteLine($"AIO test. Failed to read float from Click PLC " +
        ...
        internal static int FloatRegisterTest(string name, float value) {
            ...
            for (int i = 0; i < 10; i++) {
                if (!_driver.WriteFloat32Register(name, value + i)) {
                ...
                if (!_driver.ReadFloat32Register(name, out float readValue)) {
